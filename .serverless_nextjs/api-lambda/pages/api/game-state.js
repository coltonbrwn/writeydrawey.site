...
/******/ 	return __webpack_require__(__webpack_require__.s = "It9D");
/******/ })
/************************************************************************/
/******/ ({
...
function getCookieParser(req) {
    return function parseCookie() {
        ...
        const { parse } = __webpack_require__("oRAz");
...
/* harmony import */ var dotty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("aSVQ");
/* harmony import */ var dotty__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dotty__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("iVi/");
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("Ap7T");
...
/* harmony import */ var _backend_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("F/0o");
/* harmony import */ var _backend_constants__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_backend_constants__WEBPACK_IMPORTED_MODULE_5__);
...
const parseCookie = req => {
  ...
  return Object(dotty__WEBPACK_IMPORTED_MODULE_1__["get"])(cookie__WEBPACK_IMPORTED_MODULE_2___default.a.parse(req.headers.cookie), 'cookiedrawey');
};

function getState(req, res) {
  if (!req.query.id) {
    return _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a.reject(`Invalid gameId`);
  }

  let setCookie,
      userId = parseCookie(req);
  const url = `${baseUrl()}/state?id=${req.query.id}`;
  return axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(url).then(response => {
    if (setCookie) {
    ...
    console.log(err);
    res.status(Object(dotty__WEBPACK_IMPORTED_MODULE_1__["get"])(err, 'response.status') || 500).end();
  });
}
function updateState(req, res) {
  ...
  */
  ...
  switch (req.body.method) {
    case _backend_constants__WEBPACK_IMPORTED_MODULE_5__["API_METHODS"].CREATE_GAME:
    case _backend_constants__WEBPACK_IMPORTED_MODULE_5__["API_METHODS"].ADD_PLAYER:
      // can create new user tokens here
      if (!userId) {
        userId = Object(uuid__WEBPACK_IMPORTED_MODULE_3__["v4"])();
      }

      setCookie = cookie__WEBPACK_IMPORTED_MODULE_2___default.a.serialize('cookiedrawey', userId, {
        maxAge: 9999,
        path: '/'
      });
      break;
  ...
  return axios__WEBPACK_IMPORTED_MODULE_4___default.a.post(`${baseUrl()}/api`, {
    method,
    payload,
    viewer: {
      userId
