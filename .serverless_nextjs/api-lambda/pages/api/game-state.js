...
/******/ 	return __webpack_require__(__webpack_require__.s = "7gsD");
/******/ })
/************************************************************************/
/******/ ({
    ...
    function handleRewrites(parsedUrl) {
      for (const rewrite of rewrites) {
        ...
        if (params) {
          ...
          if (parsedUrl.pathname === '/api/game-state'){
            break
          }
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("R10H")
          await apiResolver(
            req,
            res,
            Object.assign({}, parsedUrl.query, params ),
            resolver,
            {previewModeId:"1881307ab0eec978403f3661f85b6de1",previewModeSigningKey:"220fd2f076a317ee7e80b15ed02a340d3c11fb9fd9fa4095bc413ee027b299c5",previewModeEncryptionKey:"35025b4ce07e16931ab6bf48afddaceca637f023a07490a65dc52847be4d2571"},
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_api_proxy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("sd34");

/* harmony default export */ __webpack_exports__["default"] = ((req, res) => {
  _lib_api_proxy__WEBPACK_IMPORTED_MODULE_0__[/* getState */ "a"](req, res);
});
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return updateState; });
/* harmony import */ var dotty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("aSVQ");
/* harmony import */ var dotty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dotty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("iVi/");
...
/* harmony import */ var _backend_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("F/0o");
/* harmony import */ var _backend_constants__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_backend_constants__WEBPACK_IMPORTED_MODULE_4__);
...
const parseCookie = req => {
  ...
  return Object(dotty__WEBPACK_IMPORTED_MODULE_0__["get"])(cookie__WEBPACK_IMPORTED_MODULE_1___default.a.parse(req.headers.cookie), 'cookiedrawey');
};
...
function getState(req, res) {
  ...
  let setCookie,
      userId = parseCookie(req);
  const url = `${baseUrl()}/state?id=${req.query.id}`;
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get(url).then(response => {
    if (setCookie) {
    ...
    console.log(err);
    res.status(Object(dotty__WEBPACK_IMPORTED_MODULE_0__["get"])(err, 'response.status') || 500).end();
  });
}
function updateState(req, res) {
  ...
  */
  ...
  switch (req.body.method) {
    case _backend_constants__WEBPACK_IMPORTED_MODULE_4__["API_METHODS"].CREATE_GAME:
    case _backend_constants__WEBPACK_IMPORTED_MODULE_4__["API_METHODS"].ADD_PLAYER:
      // can create new user tokens here
      if (!userId) {
        userId = Object(uuid__WEBPACK_IMPORTED_MODULE_2__["v4"])();
      }

      setCookie = cookie__WEBPACK_IMPORTED_MODULE_1___default.a.serialize('cookiedrawey', userId, {
        maxAge: 9999,
        path: '/'
      });
      break;
  ...
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post(`${baseUrl()}/api`, {
    method,
    payload,
    viewer: {
      userId
